...
const contractABI = require("../artifacts/contracts/Weaverprism.sol/Weaverprism.json").abi;

program
    .name("weaverprism-cli")
    .description("CLI tool for Weaverprism smart contract")
    .version("1.0.0");
