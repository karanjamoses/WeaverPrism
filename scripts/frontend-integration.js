 ...
 * This file demonstrates how to integrate Weaverprism with a web frontend
 */

// For React/Vue/Angular applications
export class WeaverprismClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new WeaverprismClient(provider, contractAddress);
